...
include::modules/decision-services/con-dmn-support.adoc[leveloffset=+1]
//@comment: Under investigation for Kogito. (Stetson, 5 March 2020)
//include::modules/decision-services/ref-dmn-properties.adoc[leveloffset=+2]
ifdef::KOGITO-COMM[]
include::modules/decision-services/ref-dmn-feel-enhancements.adoc[leveloffset=+2]
include::modules/decision-services/ref-dmn-model-enhancements.adoc[leveloffset=+2]
endif::[]
...
//include::modules/decision-services/con-dmn-included-models.adoc[leveloffset=+2]
//include::modules/decision-services/proc-dmn-included-models-dmn.adoc[leveloffset=+3]
//include::modules/decision-services/proc-dmn-included-models-pmml.adoc[leveloffset=+3]
...
//@comment: Not yet applicable for Kogito. (Stetson, 5 March 2020)
//include::modules/decision-services/con-dmn-execution.adoc[leveloffset=+1]
//include::modules/decision-services/proc-dmn-execution-embedded.adoc[leveloffset=+2]
//include::modules/decision-services/proc-dmn-execution-remote-java.adoc[leveloffset=+2]
//include::modules/decision-services/proc-dmn-execution-rest.adoc[leveloffset=+2]
...
//include::modules/decision-services/con-drl-globals.adoc[leveloffset=+2]
...
//include::modules/decision-services/con-drl-timers-calendars.adoc[leveloffset=+3]
