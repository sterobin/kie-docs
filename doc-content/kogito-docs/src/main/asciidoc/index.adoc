...
//Intro
include::creating-running/chap-kogito-intro.adoc[leveloffset=+1]

//Getting started
include::creating-running/chap-kogito-creating-running.adoc[leveloffset=+1]

//OpenShift
//include::decision-services/chap-kogito-deploying-on-openshift.adoc[leveloffset=+1]
...
//Glossary
include::creating-running/chap-kogito-glossary.adoc[leveloffset=+1]
