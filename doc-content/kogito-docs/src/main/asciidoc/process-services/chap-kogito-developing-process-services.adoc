...
[replace-with="./modules/creating-running/ref-kogito-app-examples.adoc" replace-with-params="leveloffset=+1"]
...
[replace-with="../decision-services/con-kogito-service-execution.adoc" replace-with-params="leveloffset=+1"]
