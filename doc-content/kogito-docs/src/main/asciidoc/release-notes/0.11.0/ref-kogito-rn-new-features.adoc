...
* https://github.com/kiegroup/kogito-examples/tree/stable/process-optaplanner-quarkus[`process-optaplanner-quarkus`]: OptaPlanner example for {PRODUCT} on Quarkus
* https://github.com/kiegroup/kogito-examples/tree/stable/process-optaplanner-springboot[`process-optaplanner-springboot`]: OptaPlanner example for {PRODUCT} on Spring Boot
...
ifdef::KOGITO-ENT[]
{URL_DECISION_SERVICES}#con-test-scenarios_kogito-test-scenarios[_{DECISION_SERVICES}_].
endif::[]
ifdef::KOGITO-COMM[]
xref:con-test-scenarios_kogito-test-scenarios[].
endif::[]
