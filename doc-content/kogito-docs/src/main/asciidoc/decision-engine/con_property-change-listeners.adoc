[id='con_property-change-listeners_{context}']
...
To set the property reactivity behavior, update the `drools.propertySpecific` system property in the `application.conf` file of your {PRODUCT} distribution:
