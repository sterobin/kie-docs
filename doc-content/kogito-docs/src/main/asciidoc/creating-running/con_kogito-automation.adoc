...
{PRODUCT} adapts to your business domain instead of forcing you to modify your domain to work with {PRODUCT}. You can expose your {PRODUCT} services with domain-specific APIs that are based on the processes and rules that you have defined and that do not include third-party or internal APIs.
