...
ifdef::env-github[]
// Only necessary if we want images displayed in GitHub
:imagesdir: ../../../../../../_images
// These next ones are here for GitHub display
:PRODUCT: Kogito
:OPENSHIFT: OpenShift
:PRODUCT_INIT: kogito
...
// I believe this is only needed for enterprise - Jason Porter
ifdef::KOGITO-ENT[]
[IMPORTANT]
====
...
// Jason Porter: I don't know of a better way to do the above. I wanted to try an ifdef, but because we have content on both sides of the variable (copy and punctuation), this is the cleanest way I can find.
...
For more information about rule units, see xref:con-drl-rule-units_drl-rules[].
...
[replace-with="designing_a_decision_service_using_dmn_models/dmn-execution.adoc" replace-with-params="leveloffset=+1]
More information about how to setup and interact with the {PRODUCT} Server REST API can be found by reading https://access.redhat.com/documentation/en-us/red_hat_decision_manager/7.8/html/getting_started_with_decision_services/dmn-execution-con#dmn-execution-rest-proc.
