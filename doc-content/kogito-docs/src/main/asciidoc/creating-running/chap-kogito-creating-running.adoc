...
ifdef::KOGITO-ENT[]
include::chap-kogito-intro.adoc[leveloffset=+1,tags=con-kogito-automation]
include::chap-kogito-intro.adoc[leveloffset=+2,tags=con-kogito-quarkus-springboot]
endif::[]
...
ifdef::KOGITO-ENT[]
include::chap-kogito-glossary.adoc[leveloffset=+1]
