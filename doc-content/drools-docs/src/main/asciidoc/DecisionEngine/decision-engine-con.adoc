...
* *Rules:* Business rules or DMN decisions that you define. All rules must contain at minimum the conditions that trigger the rule and the actions that the rule dictates.
