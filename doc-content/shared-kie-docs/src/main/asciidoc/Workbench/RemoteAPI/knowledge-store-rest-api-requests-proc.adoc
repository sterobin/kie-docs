...
The Knowledge Store REST API enables you to interact with your projects and spaces in {PRODUCT} without using {CENTRAL}. You can send Knowledge Store REST API requests using any REST client or curl utility.
