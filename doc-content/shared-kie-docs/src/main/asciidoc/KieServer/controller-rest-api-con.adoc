...
Base URL::
The base URL for {CONTROLLER} REST API requests is `\http://SERVER:PORT/CONTROLLER/rest/controller/`, such as  `\http://localhost:8080/{URL_COMPONENT_CENTRAL}/rest/controller/` if you are using the {CONTROLLER} built in to {CENTRAL}.
