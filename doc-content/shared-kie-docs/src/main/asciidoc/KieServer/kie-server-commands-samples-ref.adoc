...
Each command in this section includes a JSON request body example for the {KIE_SERVER} REST API and an embedded method example from the `KieServicesClient` Java client for the {KIE_SERVER} Java client API.
