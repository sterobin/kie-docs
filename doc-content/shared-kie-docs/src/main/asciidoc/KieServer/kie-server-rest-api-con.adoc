...
Endpoints::
{KIE_SERVER} REST API endpoints, such as `/containers/{containerId}` for a specified KIE container, are the URIs that you append to the {KIE_SERVER} base URL to access the corresponding resource or type of resource in {PRODUCT}.
+
--
